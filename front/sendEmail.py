...
- send_email function: sends an email to the user with a verification code from parampatel6844@gmail.com
 - The header of this email is Verification Code From Business Idea so need to fix it
